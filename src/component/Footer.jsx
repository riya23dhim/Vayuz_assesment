  ...
  return (
    <div className=' ml-3  mb-17 mt-20 flex  xl:gap-10 gap-2  flex-wrap'>
        ...
        <div  data-aos="fade-up"  data-aos-offset="100" className='xl:w-[55%] mt-12 w-[90%]'>
            {/* first div */}
            <div className=' w-[100%] flex gap-12 items-center '>
            ...
            <div className='tracking-widest cursor-pointer text-gray-400 text-sm mt-43 flex  gap-11 items-center'>
        ...
        <div  data-aos="fade-right"  data-aos-offset="100" className='lg:w-[35%] m-5 w-[80%] flex flex-col '>
            <p className='text-white   text-7xl font-normal pl-20 font-playfair tracking-wider  transform scale-y-120 scale-x-110 animate-pulse origin-top '>Connect With Us</p>
        {/* form */}
        <div  name="contact" className=' mt-23 mx-21'>
        ...
        <div className=' cursor-pointer group hover:scale-[1.01] flex items-center justify-center h-15 w-15  rounded-full bg-dark-hover/20 hover:bg-dark-hover cursor-pointer p-1 ml-82 mt-25   text-gray-400'><Link to="header" smooth={true} 
