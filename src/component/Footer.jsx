  ...
  return (
    <div className=' ml-3  mb-17 mt-20 flex  xl:gap-10 gap-2  flex-wrap'>
        ...
        <div  data-aos="fade-up"  data-aos-offset="100" className='xl:w-[55%] mt-12 w-[90%]'>
            ...
            <div className='tracking-widest cursor-pointer text-gray-400 text-sm mt-43 flex  gap-1 md:gap-11 items-center'>
        ...
        <div  data-aos="fade-right"  data-aos-offset="100" className='lg:w-[35%] m-5 w-[75%] flex flex-col '>
            <p className='text-white  text-3xl md:text-7xl font-normal  pl:5 md:pl-20 font-playfair tracking-wider  transform scale-y-120 scale-x-110 animate-pulse origin-top '>Connect With Us</p>
        {/* form */}
        <div  name="contact" className=' mt-23 mx-1 md:mx-21'>
            ...
            {/* margin from above */}
            <div className='relative mt-3 w-50 md:w-75'>
        ...
        {/* sunmit */}
        <div className='mt-6 ml-1 md:ml-70'>
